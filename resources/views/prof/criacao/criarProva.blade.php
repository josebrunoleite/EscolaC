                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Adicionar Nova Questão</h3>
                        </div>
                        @if (session('error'))
                        ...
                        @endif
                        <form role="form" action="{{ route('Questao.store') }}" method="post">
                            @csrf
                            <div class="card-body">
                                <!-- Aula -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="questao" class="form-control" id="questao"
