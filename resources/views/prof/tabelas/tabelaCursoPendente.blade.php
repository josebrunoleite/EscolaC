            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @endif
                        <h3 class="card-title">Tabela de Cursos Pendente a Autorização</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="{{-- table-responsive --}}table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="d-none d-md-table-cell">Professor</th>
                       ...
                       @foreach ($cursos as $cursos)
                                    <tr>
                                        ...
                                        <td>{{ $cursos->id ?? 'Error Contate José' }}</td>
                                        <td class="d-none d-md-table-cell">{{ $cursos->nome ?? 'Error Contate José' }}
                                        </td>
                                        <td class="d-none d-md-table-cell">{{ $cursos->autor ?? 'Error Contate José' }}
                                        </td>
                                        <td class="d-none d-md-table-cell">{{ $cursos->tipo ?? 'Error Contate José' }}</td>
