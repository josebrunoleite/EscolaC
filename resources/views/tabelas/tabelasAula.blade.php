            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @endif
                        <h3 class="card-title">Tabela de Aulas Existentes</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <thead>
                                <tr>
                                   ...
                                   <th class="d-none d-md-table-cell">video</th>
                                    <th class="d-none d-md-table-cell">comentarios</th>
                       ...
                       @foreach ($aulas as $aula)
                                    <tr>
                                        ...
                                        <td class="d-none d-md-table-cell">{{ $aula->titulo ?? 'Error Contate José' }}
                                        </td>
                        <td class="d-none d-md-table-cell">{{ $aula->video ?? 'Error Contate José' }}</td>
